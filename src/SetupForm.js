      ...
      <section className="quiz quiz-small">
        <form className="setup-form">
          ...
          <div className="form-control">
            ...
            value={quiz.amount} onChange={handleChange} className="form-input" min={1} max={50}/>
          </div>
          <div className="form-control">
            <label htmlFor="category"category>select category</label>
          ...
          <div className="form-control">
            ...
            <select name="difficulty" id="difficulty" className="form-input" value={quiz.difficulty} onChange={handleChange}>
              <option value="eaasy">easy</option>
